    ...
    subroutine initialize_lib_node()
        ...
        call update(lib_node(7),key=1,x=[zero,zero,zero],u=[zero,zero,zero])
        call update(lib_node(8),key=2,x=[one,zero,zero],u=[zero,zero,zero])
        call update(lib_node(9),key=3,x=[zero,one,zero],u=[zero,zero,zero])
        call update(lib_node(10),key=4,x=[one,one,zero],u=[zero,zero,zero])
        call update(lib_node(11),key=5,x=[zero,two,zero],u=[zero,zero,zero])
        call update(lib_node(12),key=6,x=[one,two,zero],u=[zero,zero,zero])
